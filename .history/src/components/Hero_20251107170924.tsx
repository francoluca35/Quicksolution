          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gradient-to-r from-green-800 to-green-600 rounded-lg flex items-center gap-2 hover:shadow-lg hover:shadow-orange-500/30 transition-shadow text-white"
              >
                Comenzar Ahora
