  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 hover:text-green-700">
          {/* Logo */}
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-6 py-2 bg-gradient-to-r from-green-700 to-green-800 text-white rounded-lg hover:shadow-lg hover:shadow-orange-500/30 transition-shadow"
            >
              Comenzar Ahora
            </motion.a>
          </div>
        ...
        {isOpen && (
          ...
          >
            ...
            <a
              href="#pricing"
              onClick={() => setIsOpen(false)}
              className="block mt-4 px-6 py-3 bg-gradient-to-r from-green-800 to-green-900 text-white rounded-lg text-center"
            >
              Comenzar Ahora
            </a>
          </motion.div>
