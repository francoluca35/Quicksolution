            ...
            <div className="relative z-10 text-center">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-8 py-4 bg-gradient-to-r from-red-500 to-amber-600 text-white rounded-lg flex items-center gap-2 hover:shadow-lg hover:shadow-orange-500/30 transition-shadow"
                >
