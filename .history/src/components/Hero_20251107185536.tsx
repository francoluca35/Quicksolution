          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gradient-to-r hover:text-black from-green-800 to-green-900 rounded-lg flex items-center gap-2 hover:shadow-lg transition-shadow text-white"
              >
