      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {videos.map((video, index) => (
            ...
            >
              <div className="relative overflow-hidden rounded-2xl bg-slate-800/50 border border-slate-700/50 hover:border-orange-500/50 transition-all">
                {/* Video Thumbnail */}
                <div className="relative aspect-video overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/40 flex items-center justify-center group-hover:bg-black/30 transition-colors">
                    <div className="w-16 h-16 rounded-full bg-gradient-to-r from-orange-500 to-amber-600 flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg">
